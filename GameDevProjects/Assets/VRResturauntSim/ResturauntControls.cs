...
public partial class @ResturauntControls: IInputActionCollection2, IDisposable
{
    ...
    ~@ResturauntControls()
    {
        UnityEngine.Debug.Assert(!m_Pause.enabled, "This will cause a leak and performance issues, ResturauntControls.Pause.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Walking.enabled, "This will cause a leak and performance issues, ResturauntControls.Walking.Disable() has not been called.");
    }
